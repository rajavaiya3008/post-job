...
const initialState = {
    contractValidation:{...contValidation,['1stReplacement']: [{ required: true, message: "Please Enter Replacement" }]},
    replacementFields:[{
        type:'number',
        id:`1stReplacement`,
        name:`1stReplacement`,
...
export const {handleReplacementFields,handleContractValidation} = postJobSlice.actions
